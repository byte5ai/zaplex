...
//!
//! ## How does a11y work in Zaplex?
//! Because Zaplex uses its own rust UI framework (warpui), we don’t benefit from the built-in
...
pub struct AccessibilityContent {
    ...
    /// Frame support is a work-in-progress in Zaplex and right now this field is omitted and not set.
