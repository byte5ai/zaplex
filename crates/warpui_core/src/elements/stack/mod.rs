...
impl Element for Stack {
    ...
    fn paint(&mut self, origin: Vector2F, ctx: &mut PaintContext, app: &AppContext) {
        ...
        for child in &mut self.children {
            // Overlay child elements use overlay layer to get Overlay z-index,
            // avoid is_covered misjudging own child elements' hit rect as blocked during event dispatch.
