...
pub use oauth::{apply_oauth_usage, parse_oauth_usage, OauthUsage, OauthWindow, UtilizationScale};
...
#[expect(
    ...
    reason = "the cached entry point mirrors the explicit snapshot inputs plus its cache"
)]
