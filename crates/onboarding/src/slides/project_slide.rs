...
impl ProjectSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let subtitle = appearance
            ...
            .paragraph(localized(
                ...
                "Set up a project to optimize it for coding in Zaplex.",
            ))
            .with_style(UiComponentStyles {
                font_size: Some(20.),
    ...
    fn render_bottom_nav(
        ...
        let theme_picker_last =
            warp_core::features::FeatureFlag::ZaplexNewSettingsModes.is_enabled();
...
impl ProjectSlide {
    ...
    fn next(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        self.onboarding_state.update(ctx, |model, ctx| {
            if warp_core::features::FeatureFlag::ZaplexNewSettingsModes.is_enabled() {
                model.next(ctx);
            } else {
                model.complete(ctx);
            }
