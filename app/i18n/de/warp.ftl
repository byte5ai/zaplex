...
fm-toast-server-config-read-failed = Server-Konfiguration konnte nicht gelesen werden: { $err }
...
fm-toast-symlink-target-unresolved = Ziel der Verknüpfung konnte nicht aufgelöst werden: { $err }
