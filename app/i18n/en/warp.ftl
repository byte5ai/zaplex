# Zaplex Desktop — English (source-of-truth locale)
...
agent-management-source-local-agent = Zaplex (local agent)
...
workspace-menu-update-warp-manually = Update Zaplex manually
...
workspace-menu-view-warp-logs = View Zaplex logs
...
app-menu-set-default-terminal = Set Zaplex as Default Terminal
app-menu-file = File
app-menu-edit = Edit
app-menu-use-warp-prompt = Use Zaplex's Prompt
...
app-menu-show-zaplexified-ssh-blocks = Show Zaplexified SSH Blocks
app-menu-hide-zaplexified-ssh-blocks = Hide Zaplexified SSH Blocks
...
app-menu-help = Help
app-menu-warp-documentation = Zaplex Documentation...
app-menu-github-issues = GitHub Issues...
app-menu-warp-slack-community = Zaplex Slack Community...
workspace-update-and-relaunch-warp = Update and relaunch Zaplex
workspace-updating-to-version = Updating to ({ $version })
workspace-update-warp-manually = Update Zaplex manually
...
terminal-banner-completions-not-working-middle = ). Enabling tmux zaplexification in {" "}
terminal-banner-settings = settings
terminal-banner-completions-not-working-suffix =  may resolve this issue.
terminal-banner-shell-config-incompatible = Your shell configuration is incompatible with Zaplex...{"  "}
...
ssh-remote-choice-install-extension = Install Zaplex's SSH extension
ssh-remote-choice-install-extension-desc = Install Zaplex's extension to enable agent features like file browsing, code review, and intelligent command completions in this session.
ssh-remote-choice-continue-without-installing = Continue without installing
ssh-remote-choice-continue-without-installing-desc = You'll still get a Zaplexified experience just without the agent features.
ssh-remote-choice-manage-zaplexify-settings = Manage Zaplexify settings
ai-document-show-version-history = Show version history
ai-document-update-agent = Update Agent
ai-document-save-and-sync-tooltip = Save and auto-sync this plan to your Zaplex Drive
ai-document-show-in-warp-drive = Show in Zaplex Drive
...
ai-footer-enable-notifications-tooltip = Install the Warp plugin to enable rich agent notifications within Zaplex
...
ai-footer-subscription-agent-settings = Agent settings
ai-footer-subscription-allow = Allow
ai-footer-subscription-allow-for-session = Allow for session
ai-footer-subscription-resume = Resume
ai-footer-subscription-restart = Restart
ai-footer-subscription-end = End
ai-footer-subscription-new-conversation = New conversation
ai-footer-subscription-back-to-shell = Back to shell
ai-footer-subscription-change-agent = Change agent
ai-footer-subscription-change-account = Change account
ai-footer-subscription-change-model = Change model
ai-footer-subscription-choose-agent = Choose agent
ai-footer-subscription-choose-account = Choose account
ai-footer-subscription-choose-model = Choose model
ai-footer-subscription-switch-location = Switch to { $host } · Directory { $directory }
ai-footer-subscription-local-machine = Local machine
ai-footer-subscription-choose-directory = Choose directory…
ai-footer-subscription-enter-remote-directory = Enter an absolute remote directory or .…
ai-footer-subscription-use-directory = Use directory { $directory }
ai-footer-subscription-use-host-default-directory = Use host default directory
ai-footer-subscription-location = Host { $host } · Directory { $directory }
ai-footer-subscription-selection-required = Selection required
ai-footer-subscription-selection-required-detail = Choose an agent, account, or model before sending a prompt.
ai-footer-subscription-selection-required-disabled = Choose an agent, account, or model before sending a prompt.
ai-footer-subscription-status-no-agent = No supported agent installed
ai-footer-subscription-detail-no-agent = Install Claude Code or Codex, then return to this conversation.
ai-footer-subscription-status-not-signed-in = { $agent } is not signed in
ai-footer-subscription-detail-not-signed-in = Sign in with { $agent } before sending this prompt.
ai-footer-subscription-status-ready = Ready
ai-footer-subscription-detail-ready = The selected agent is ready for your next prompt.
ai-footer-subscription-status-starting = Starting
ai-footer-subscription-detail-starting = The selected agent session is starting.
ai-footer-subscription-status-responding = Responding
ai-footer-subscription-detail-responding = The selected agent is responding.
ai-footer-subscription-status-running-tool = Running { $tool }
ai-footer-subscription-detail-running-tool = The selected agent is running { $tool }.
ai-footer-subscription-status-waiting-for-approval = Waiting for approval
ai-footer-subscription-detail-waiting-for-approval = Review the requested action before the agent can continue.
ai-footer-subscription-status-turn-complete = Turn complete
ai-footer-subscription-detail-turn-complete = Continue the recorded session or start over.
ai-footer-subscription-status-session-ended = Session ended
ai-footer-subscription-detail-session-ended = This session cannot accept more prompts.
ai-footer-subscription-identity-id = ID { $id }
ai-footer-subscription-identity-named-id = { $name } · ID { $id }
ai-footer-subscription-model-resolved = resolved { $model }
ai-footer-subscription-field-agent = Agent
ai-footer-subscription-field-account = Account
ai-footer-subscription-field-host = Host
ai-footer-subscription-field-directory = Directory
ai-footer-subscription-field-model = Model
ai-footer-subscription-field-session = Session
ai-footer-subscription-field-status = Status
ai-footer-subscription-status-incompatible-cli = Incompatible agent CLI
ai-footer-subscription-status-remote-unavailable = Remote host unavailable
ai-footer-subscription-status-model-discovery-failed = Model discovery failed
ai-footer-subscription-status-needs-attention = Agent needs attention
ai-footer-subscription-disabled-no-agent = Install a supported agent before sending a prompt.
ai-footer-subscription-disabled-not-signed-in = Sign in with { $agent } before sending a prompt.
ai-footer-subscription-disabled-starting = Wait for the agent session to start.
ai-footer-subscription-disabled-responding = Wait for the current response to finish.
ai-footer-subscription-disabled-running-tool = Wait for { $tool } to finish.
ai-footer-subscription-disabled-waiting-for-approval = Resolve the approval request before sending another prompt.
ai-footer-subscription-disabled-session-ended = Start a new conversation or return to the shell.
ai-footer-subscription-disabled-recoverable-error = Recover or restart the agent session before sending another prompt.
ai-footer-subscription-recoverable-error-fallback = The agent reported a recoverable error.
ai-footer-subscription-session-claude = Claude { $id }
ai-footer-subscription-session-codex = Codex { $id }
...
zap-launch-title = Zaplex is now open-source
zap-launch-description = You, our community, can participate in building Zaplex using an agent-first workflow.
zap-launch-contribute-title = Contribute
zap-launch-contribute-description = Zaplex's client code is now open source. Get started by using the /feedback skill to open an issue, and follow the contribution guidelines here.
zap-launch-contribute-link-text = here
zap-launch-oad-title = Open Automated Development
zap-launch-oad-description = The Zaplex repo is managed by an agent-first local workflow.
...
git-dialog-loading-commit = Committing…
git-dialog-loading-publish = Publishing…
git-dialog-loading-push = Pushing…
git-dialog-loading-create-pr = Creating…
git-dialog-commit-need-message = Enter a commit message
...
terminal-zaplexify-subshell = Zaplexify subshell
terminal-zaplexify-subshell-tooltip = Enable Zaplex shell integration in this session
terminal-use-agent = Use agent
terminal-use-agent-tooltip = Ask the Zaplex agent to assist
terminal-give-control-back-to-agent = Give control back to agent
terminal-resume-agent-tooltip = Ask the Zaplex agent to resume
...
terminal-open-in-warp = Open in Zaplex
terminal-open-conversation-in-warp-tooltip = Open this conversation in the Zaplex desktop app
...
terminal-input-agent-hint-deploy-react-vercel = Zaplex anything e.g. Deploy my React app to Vercel and set up environment variables
terminal-input-agent-hint-debug-python-ci = Zaplex anything e.g. Help me debug why my Python tests are failing in CI
terminal-input-agent-hint-setup-microservice = Zaplex anything e.g. Set up a new microservice with Docker and create the deployment pipeline
terminal-input-agent-hint-fix-node-memory-leak = Zaplex anything e.g. Find and fix the memory leak in my Node.js application
terminal-input-agent-hint-backup-postgres = Zaplex anything e.g. Create a backup script for my PostgreSQL database and schedule it
terminal-input-agent-hint-migrate-mysql-postgres = Zaplex anything e.g. Help me migrate my data from MySQL to PostgreSQL
terminal-input-agent-hint-monitor-aws = Zaplex anything e.g. Set up monitoring and alerts for my AWS infrastructure
terminal-input-agent-hint-build-fastapi = Zaplex anything e.g. Build a REST API for my mobile app using FastAPI
terminal-input-agent-hint-optimize-sql = Zaplex anything e.g. Help me optimize my SQL queries that are running slowly
terminal-input-agent-hint-github-actions = Zaplex anything e.g. Create a GitHub Actions workflow to automatically deploy on merge
terminal-input-agent-hint-redis-cache = Zaplex anything e.g. Set up Redis caching for my web application
terminal-input-agent-hint-kubernetes-pods = Zaplex anything e.g. Help me troubleshoot why my Kubernetes pods keep crashing
terminal-input-agent-hint-bigquery-pipeline = Zaplex anything e.g. Build a data pipeline to process CSV files and load them into BigQuery
terminal-input-agent-hint-ssl-https = Zaplex anything e.g. Set up SSL certificates and configure HTTPS for my domain
terminal-input-agent-hint-refactor-legacy-code = Zaplex anything e.g. Help me refactor this legacy code to use modern design patterns
terminal-input-agent-hint-unit-tests = Zaplex anything e.g. Create unit tests for my authentication service
terminal-input-agent-hint-elk-logs = Zaplex anything e.g. Set up log aggregation with ELK stack for my distributed system
terminal-input-agent-hint-oauth-express = Zaplex anything e.g. Help me implement OAuth2 authentication in my Express.js app
terminal-input-agent-hint-optimize-docker = Zaplex anything e.g. Optimize my Docker images to reduce build times and size
terminal-input-agent-hint-ab-testing = Zaplex anything e.g. Set up A/B testing infrastructure for my web application
...
onboarding-callout-meet-input-title = Meet the Zaplex input
...
onboarding-callout-nl-support-text-prefix = Natural language input is off by default. If enabled, you can type requests in plain English and Zaplex will autodetect queries for the agent. You can always override them using
onboarding-callout-enable-nl-detection = Enable Natural Language Detection
onboarding-callout-new-agent-title = Introducing Zaplex's new agent experience
...
language-widget-secondary = Restart Zaplex for the change to fully take effect.
language-restart-required-title = Language changed
language-restart-required-body = Zaplex's UI language has been updated. Some text will switch immediately, but a full restart is required for the change to take effect everywhere.
...
# Zaplex: settings-section-account removed alongside the Account settings page.
...
settings-about-automatic-updates-description = When enabled, Zaplex checks for new versions in the background and downloads the installer to a local cache. The currently running Zaplex is not touched until you click "Install now" to launch the installer yourself.
settings-about-update-checking = Checking for updates…
settings-about-update-up-to-date = Zaplex is up to date.
...
settings-about-update-install-hint-macos = The installer will open — drag Zaplex into your Applications folder to finish.
settings-about-update-install-hint-windows = The setup wizard will launch — follow the prompts to finish the upgrade.
settings-about-update-install-hint-linux = The AppImage will be replaced in place and Zaplex will restart.
...
# Zaplex: main_page.rs (Account / version / autoupdate) strings removed alongside
...
# ---- list_page.rs ----
settings-mcp-list-description = Add MCP servers to extend the Zaplex Agent's capabilities. MCP servers expose data sources or tools to agents through a standardized interface, essentially acting like plugins. Add a custom server, or use the presets to get started with popular servers.
...
settings-mcp-list-section-shared-by-warp-and-team = Available from Zaplex and { $name }
settings-mcp-list-section-shared-by-warp-and-other-devices = Shared by Zaplex and from other devices
settings-mcp-list-section-shared-from-warp = Shared from Zaplex
...
settings-platform-description = Create and manage API keys to allow local agents to access your Zaplex account.
...
settings-platform-zero-state-description = Create a key to manage external access to Zaplex
settings-platform-create-api-key-description-personal = This API key is tied to your user and can make requests against your Zaplex account.
...
settings-platform-create-api-key-name-placeholder = Zaplex API Key
...
settings-referrals-page-title = Invite a friend to Zaplex
settings-referrals-anonymous-header = Referral program is unavailable in local Zaplex builds
...
settings-referrals-reward-intro = Get exclusive Zaplex goodies when you refer someone*
...
# --- ANCHOR-SUB-ZAPLEXIFY (agent-settings-zaplexify) ---
settings-zaplexify-page-title = Zaplexify
settings-zaplexify-description-prefix = Configure whether Zaplex attempts to "Zaplexify" (add support for blocks, input modes, etc) certain shells.
settings-zaplexify-learn-more = Learn more
settings-zaplexify-section-subshells = Subshells
settings-zaplexify-section-subshells-subtitle = Subshells supported: bash, zsh, and fish.
settings-zaplexify-section-ssh = SSH
settings-zaplexify-section-ssh-subtitle = Zaplexify your interactive SSH sessions.
settings-zaplexify-added-commands = Added commands
settings-zaplexify-denylisted-commands = Denylisted commands
settings-zaplexify-denylisted-hosts = Denylisted hosts
settings-zaplexify-command-placeholder = command (supports regex)
settings-zaplexify-host-placeholder = host (supports regex)
settings-zaplexify-enable-ssh = Zaplexify SSH Sessions
settings-zaplexify-install-ssh-extension = Install SSH extension
settings-zaplexify-install-ssh-extension-description = Controls the installation behavior for Zaplex's SSH extension when a remote host doesn't have it installed.
settings-zaplexify-use-tmux = Use Tmux Zaplexification
settings-zaplexify-tmux-description = The tmux ssh wrapper works in many situations where the default one does not, but may require you to hit a button to zaplexify. Takes effect in new tabs.
settings-zaplexify-ssh-tmux-toggle-binding-label = SSH session detection for Zaplexification
...
settings-network-description = Configure a global proxy for all outbound HTTP / WebSocket requests. Press Enter after editing a field to save.\nNew requests (connection tests, conversation loading, etc.) take effect immediately; long-lived clients constructed at startup (autoupdate, changelog) require an app restart.
...
settings-ai-command-denylist-description = Regular expressions to match commands that the Zaplex Agent should always ask permission to execute.
settings-ai-command-allowlist = Command allowlist
settings-ai-command-allowlist-description = Regular expressions to match commands that can be automatically executed by the Zaplex Agent.
...
settings-ai-mcp-allowlist-description = Allow the Zaplex Agent to call these MCP servers.
settings-ai-mcp-denylist = MCP denylist
settings-ai-mcp-denylist-description = The Zaplex Agent will always ask for permission before calling any MCP servers on this list.
...
settings-ai-base-model-description = This model serves as the primary engine behind the Zaplex Agent. It powers most interactions and invokes other models for tasks like planning or code generation when necessary. Zaplex may automatically switch to alternate models based on model availability or for auxiliary tasks such as conversation summarization.
settings-ai-show-model-picker-in-prompt = Show model picker in prompt
settings-ai-codebase-context = Codebase Context
settings-ai-codebase-context-description = Allow the Zaplex Agent to generate an outline of your codebase that can be used for context. No code is ever stored on our servers.
...
settings-ai-rules-description = Rules help the Zaplex Agent follow your conventions, whether for codebases or specific workflows.
...
settings-ai-live-agent-status-description = Reliably detects working, waiting, and completion through local agent hooks.
settings-ai-live-agent-status-off = Off
settings-ai-live-agent-status-off-detail = Basic terminal status remains available.
settings-ai-live-agent-status-review = Review required
settings-ai-live-agent-status-review-detail = Hook installed; review it once in Codex under /hooks.
settings-ai-live-agent-status-installed = Installed
settings-ai-live-agent-status-installed-unverified-detail = Hook installed; status activity has not been verified yet.
settings-ai-live-agent-status-installed-detail = Native status hooks are active.
settings-ai-live-agent-status-error = Error
settings-ai-live-agent-status-privacy = Stays local: Zaplex only receives agent state, session ID, working directory, and tool name—never prompts, commands, or tool input.
...
settings-ai-cloud-agent-computer-use-description = Enable computer use in agent conversations started from the Zaplex app.
...
settings-features-ssh-auto-discovery = Suggest hosts from ~/.ssh/config when adding
settings-features-receive-desktop-notifications = Receive desktop notifications from Zaplex
...
settings-features-make-default-terminal = Make Zaplex the default terminal
...
settings-features-default-terminal-current = Zaplex is the default terminal
...
settings-features-restart-warp-to-apply = Restart Zaplex for changes to take effect.
...
settings-exec-profile-editor-base-model-desc = This model serves as the primary engine behind the agent. It powers most interactions and invokes other models for tasks like planning or code generation when necessary. Zaplex may automatically switch to alternate models based on model availability or for auxiliary tasks such as conversation summarization.
...
settings-exec-profile-editor-command-allowlist-desc = Regular expressions to match commands that can be automatically executed by the agent.
...
settings-exec-profile-editor-mcp-allowlist-desc = MCP servers that are allowed to be called by the agent.
settings-exec-profile-editor-mcp-denylist = MCP denylist
settings-exec-profile-editor-mcp-denylist-desc = MCP servers that are not allowed to be called by the agent.
...
settings-show-blocks-confirm-dialog-text = Are you sure you want to unshare this block?
    ...
    It will no longer be accessible by link and will be permanently deleted from Zaplex servers.
...
settings-appearance-custom-icon-restart-warning = You may need to restart Zaplex for MacOS to apply the preferred icon style.
...
settings-appearance-input-mode-pinned-bottom = Pin to the bottom (Zaplex mode)
...
settings-environments-section-team-default = Provided by Zaplex and this device
settings-environments-section-team-named = Shared by Zaplex and { $team }
...
quit-warning-title-app = Quit Zaplex?
...
# Manage Rules 页面(Zaplex Drive 中的 AI Fact Collection)。
...
keybinding-desc-workspace-left-panel-warp-drive = Left Panel: Zaplex Drive
keybinding-desc-workspace-left-panel-ssh-manager = Left Panel: Connections
...
keybinding-desc-workspace-toggle-warp-drive = Toggle Zaplex Drive
...
keybinding-desc-workspace-search-drive = Search Zaplex Drive
...
keybinding-desc-workspace-terminate-app = Quit Zaplex
...
keybinding-desc-workspace-export-all-warp-drive-objects = Export all Zaplex Drive objects
keybinding-desc-workspace-install-cli = Install Zaplex CLI command
keybinding-desc-workspace-uninstall-cli = Uninstall Zaplex CLI command

# AI assistant / agents
keybinding-desc-workspace-toggle-ai-assistant = Toggle Zaplex AI
...
# Zaplex: keybinding-desc-workspace-show-settings-account removed alongside the
...
keybinding-desc-workspace-show-settings-about-menu = About Zaplex
keybinding-desc-workspace-show-settings-zaplexify = Open Settings: Zaplexify
keybinding-desc-workspace-show-settings-zaplexify-menu = Configure Zaplexify...
keybinding-desc-workspace-show-settings-ai = Open Settings: Agents
...
keybinding-desc-workspace-send-feedback-oz = Send feedback
keybinding-desc-workspace-view-logs = View Zaplex logs
...
keybinding-desc-input-show-network-log = Show Zaplex network log
...
keybinding-desc-terminal-zaplexify-subshell = Zaplexify subshell
keybinding-desc-terminal-zaplexify-ssh-session = Zaplexify ssh session
...
keybinding-desc-ai-assistant-close = Close Zaplex AI
keybinding-desc-ai-assistant-focus-terminal-input = Focus Terminal Input From Zaplex AI
keybinding-desc-ai-assistant-restart = Restart Zaplex AI
...
keybinding-desc-terminal-ask-ai-selection = Ask Zaplex AI about Selection
keybinding-desc-terminal-ask-ai-last-block = Ask Zaplex AI about last block
keybinding-desc-terminal-ask-ai = Ask Zaplex AI
...
toggle-suffix-ssh-auto-discovery = suggest hosts from ~/.ssh/config when adding
...
settings-external-editor-choose-layout = Choose a layout to open files in Zaplex
...
settings-external-editor-prefer-markdown = Open Markdown files in Zaplex's Markdown Viewer by default
...
menu-block-open-in-warp = Open in Zaplex
...
menu-block-ask-warp-ai = Ask Zaplex AI
...
menu-input-ask-warp-ai = Ask Zaplex AI
...
slash-cmd-create-environment-desc = Create an agent environment (Docker image + repos) via guided setup
...
slash-cmd-open-skill-desc = Open a skill's markdown file in Zaplex's built-in editor
...
slash-cmd-open-file-desc = Open a file in Zaplex's code editor
...
welcome-tips-command-palette-description = Easily discover everything you can do in Zaplex without your hands leaving the keyboard.
...
welcome-tips-theme-picker-description = Make Zaplex your own by choosing a built-in theme. Or create your own.
...
drive-local-storage-limit-description = Local storage limits are enforced on this device. Remove unused items to create space for new Zaplex Drive objects.
...
cockpit-transcript-title = { $provider } transcript
cockpit-transcript-missing = No transcript history is available for this session.
cockpit-transcript-empty = The transcript exists but contains no conversation turns.
cockpit-transcript-unsupported = This transcript format is not supported by this Zaplex version.
cockpit-transcript-malformed = The transcript is malformed and cannot be displayed safely.
cockpit-transcript-too-large = The transcript exceeds the safe display limits.
cockpit-transcript-unavailable = The transcript is currently unavailable. Please try again.
cockpit-transcript-truncated = Older or oversized content was omitted at the safe display limits.
cockpit-transcript-open-error = The transcript could not be opened safely. Please try again.
cockpit-remote-transcript-open-error = The remote transcript could not be loaded safely. Please try again.
...
cockpit-scan-failed = Some accounts could not be read.
cockpit-retry = Try again
cockpit-disabled = The cockpit is turned off.
...
workspace-left-panel-ssh-manager-diagnostics-title = Runtime diagnostics
workspace-left-panel-ssh-manager-diagnostics-refresh = Refresh
workspace-left-panel-ssh-manager-diagnostics-loading = Loading measured runtime diagnostics…
workspace-left-panel-ssh-manager-diagnostics-refreshing = Refreshing; retained measurements are marked stale.
workspace-left-panel-ssh-manager-diagnostics-retained-stale = Refresh failed; retained measurements are stale.
workspace-left-panel-ssh-manager-diagnostics-available = Available
workspace-left-panel-ssh-manager-diagnostics-unavailable = Unavailable
workspace-left-panel-ssh-manager-diagnostics-unsupported = Unsupported
workspace-left-panel-ssh-manager-diagnostics-stale = Measurement stale
workspace-left-panel-ssh-manager-diagnostics-not-configured = Not configured
workspace-left-panel-ssh-manager-diagnostics-auth-unavailable = Runtime diagnostics are unavailable because the saved authentication cannot be resolved.
workspace-left-panel-ssh-manager-diagnostics-needs-key = Runtime diagnostics require key-based authentication.
workspace-left-panel-ssh-manager-diagnostics-platform-unavailable = Runtime diagnostics are unavailable on this platform.
workspace-left-panel-ssh-manager-diagnostics-runtime-identity = { $version } · { $runtime }
workspace-left-panel-ssh-manager-diagnostics-output-cap = Output-ring capacity
workspace-left-panel-ssh-manager-diagnostics-host-available = Host available memory
workspace-left-panel-ssh-manager-diagnostics-memory-floor = Daemon minimum available memory
workspace-left-panel-ssh-manager-diagnostics-memavailable = MemAvailable · Linux
workspace-left-panel-ssh-manager-diagnostics-pss = Proportional set size (PSS) · Linux
workspace-left-panel-ssh-manager-diagnostics-session = Session { $id }
workspace-left-panel-ssh-manager-diagnostics-session-output = { $session } · output-ring usage
workspace-left-panel-ssh-manager-diagnostics-session-process = { $session } · process memory
...
workspace-left-panel-ssh-manager-onekey-manager-subtitle = Reuse one credential across SSH hosts.
...
workspace-left-panel-ssh-manager-onekey-unsaved-changes = Save, discard, or cancel before leaving these changes.
workspace-left-panel-ssh-manager-delete-title = Delete “{ $name }”?
workspace-left-panel-ssh-manager-delete-host-summary = This permanently deletes this saved host and its stored host credentials.
workspace-left-panel-ssh-manager-delete-folder-empty = This permanently deletes this empty folder.
workspace-left-panel-ssh-manager-delete-folder-summary =
    { $count ->
        [one] This permanently deletes this folder, the saved host it contains, and that host’s stored credentials.
...
workspace-left-panel-ssh-manager-menu-sessions = Zaplex sessions
workspace-left-panel-ssh-manager-menu-refresh-sessions = Refresh Zaplex sessions
menu-pane-open-file-manager = Open file manager here
sftp-local-file-manager-title = Files (local)
sftp-context-menu-open = Open
sftp-context-menu-download = Download
sftp-context-menu-rename = Rename
sftp-context-menu-delete = Delete
...
workspace-left-panel-ssh-manager-zaplex-sessions = Zaplex sessions
...
terminal-cli-agent-restore-resume = Continue session
terminal-cli-agent-restore-keep-shell = Keep shell
terminal-cli-agent-restore-route = { $account } · { $cwd }
terminal-cli-agent-restore-default-account = Default account
cockpit-task-peek-title = Tasks · { $completed }/{ $total } complete
cockpit-task-peek-account = Account: { $value }
cockpit-task-peek-host = Host: { $value }
cockpit-task-peek-directory = Folder: { $value }
cockpit-task-peek-activity = Latest activity: { $value }
cockpit-task-peek-no-plan = No structured task plan
...
theme-editor-choose-template = Choose a template
theme-editor-template-current = Current theme
theme-editor-templates = Templates
theme-editor-from-image = From image
theme-editor-import = Import
theme-editor-export = Export
theme-editor-discard = Discard
theme-editor-save = Save
theme-editor-primary-colors = Primary colors
theme-editor-background = Background
theme-editor-foreground = Foreground
theme-editor-accent = Accent
theme-editor-outline = Outline
theme-editor-selection = Selection
theme-editor-cursor = Cursor
theme-editor-solid = Solid
theme-editor-vertical = Vertical
theme-editor-horizontal = Horizontal
theme-editor-ansi = ANSI colors
theme-editor-ansi-normal = Normal
theme-editor-ansi-bright = Bright
theme-editor-ui-show = Show UI colors
theme-editor-ui-hide = Hide UI colors
theme-editor-ui-auto = Use automatic UI colors
theme-editor-preview-title = Live preview
theme-editor-preview-text = $ zaplex theme --preview
theme-editor-invalid-color = One or more colors are invalid. The live theme still uses the last valid values.
theme-editor-invalid-save = Fix invalid colors before saving.
theme-editor-invalid-name = Enter a theme name containing letters or numbers.
theme-editor-unsaved-title = Unsaved theme changes
theme-editor-unsaved-body = Save these changes, discard them, or cancel and keep editing.
theme-editor-color-black = Black
theme-editor-color-red = Red
theme-editor-color-green = Green
theme-editor-color-yellow = Yellow
theme-editor-color-blue = Blue
theme-editor-color-magenta = Magenta
theme-editor-color-cyan = Cyan
theme-editor-color-white = White
theme-editor-ui-surface-1 = Surface 1
theme-editor-ui-surface-2 = Surface 2
theme-editor-ui-surface-3 = Surface 3
theme-editor-ui-border = Border
theme-editor-ui-focus-border = Focus border
theme-editor-ui-split-pane-border = Split-pane border
theme-editor-ui-main-text = Main text
theme-editor-ui-sub-text = Secondary text
theme-editor-ui-hint-text = Hint text
theme-editor-ui-disabled-text = Disabled text
theme-editor-ui-selection = Selection
theme-editor-ui-text-selection = Text selection
theme-editor-ui-hover = Hover
theme-editor-ui-active = Active
theme-editor-ui-warning = Warning
theme-editor-ui-error = Error
theme-editor-ui-success = Success
theme-editor-ui-link = Link
theme-editor-error-gradient = Could not change the gradient: { $error }
theme-editor-error-ui-reset = Could not reset the UI colors: { $error }
theme-editor-error-image-prepare = Could not prepare the theme image: { $error }
theme-editor-error-export = Could not export the theme: { $error }
theme-editor-error-import = Could not import the theme: { $error }
theme-editor-error-image = Could not create a theme from the image: { $error }
theme-editor-error-local-files = Theme import requires local file access.
theme-editor-error-export-write = Could not write the exported theme: { $error }
workspace-left-panel-ssh-manager-multiplexer-metadata = { $kind } · { $windows } windows · { $clients } clients
workspace-left-panel-ssh-manager-multiplexer-scan-error = Multiplexer discovery failed: { $detail }
workspace-left-panel-ssh-manager-multiplexer-invalid = This multiplexer session has no supported type.
workspace-left-panel-ssh-manager-multiplexer-host-missing = The saved host no longer exists.
workspace-left-panel-ssh-manager-multiplexer-attach-error = Could not open multiplexer session: { $detail }
...
workspace-left-panel-ssh-manager-error-startup-command-single-line = Startup command must be a single line.
workspace-left-panel-ssh-manager-connect = Connect
workspace-left-panel-ssh-manager-disconnect = Disconnect
...
workspace-left-panel-ssh-manager-tree-empty = No SSH servers yet. Use the folder button to add a folder, + to add a server.
...
server-file-browser-transfer-safe-file-required = Secure transfers require a connected, up-to-date Zaplex remote server. Reconnect the SSH session and try again.
server-file-browser-transfer-unsupported-entry = Cannot transfer “{ $path }”: symbolic links and special files are not supported.
server-file-browser-download-size-changed = Download aborted because “{ $path }” changed size during transfer.
server-file-browser-download-source-changed = Download aborted because “{ $path }” changed during transfer.
...
server-file-browser-download-status-overwritten = Overwritten
server-file-browser-download-status-skipped = Skipped
server-file-browser-download-status-failed = Failed: { $error }
server-file-browser-download-conflict-title = Existing download targets
server-file-browser-download-conflict-info = The following local files already exist. Choose how to proceed:
server-file-browser-download-conflict-overwrite = Overwrite all
server-file-browser-download-conflict-skip = Skip existing
server-file-browser-download-summary = Download complete: { $overwritten } overwritten, { $skipped } skipped, { $failed } failed.
...
server-file-browser-upload-promote-recovery = { $error } Uploaded data was kept at { $path } for recovery.
server-file-browser-upload-promote-verify = Upload commit verification failed for { $path }.
...
wasm-nux-open-desktop-title = Open in Zaplex Desktop?
wasm-nux-open-desktop-detail = Future links will automatically open on desktop.
wasm-nux-open-desktop-confirm = Open in Zaplex
wasm-nux-download-title = Download Zaplex Desktop?
wasm-nux-download-description = Zaplex is the intelligent terminal with AI and your dev team's knowledge built-in.
wasm-nux-learn-more = Learn more
wasm-nux-download-confirm = Download
wasm-nux-object-kind-drive-objects = Zaplex Drive objects
...
auth-override-warning-confirm-title = Delete personal Zaplex Drive objects and preferences?
auth-override-warning-description = It looks like you logged into a Zaplex account through a web browser. If you continue, any personal Zaplex Drive objects and preferences from this anonymous session will be permanently deleted.
...
auth-override-warning-accessibility-help = Zaplex has detected a new login from a web browser. Press escape to cancel and continue using Zaplex without login.
...
auth-needs-sso-link-detail = Click the button below to link your Zaplex account to your SSO provider.
...
auth-offline-first-use-description = You are currently offline. An internet connection is required to use Zaplex for the first time.
auth-offline-first-use-learn-more = Learn more
auth-offline-overlay-title = Using Zaplex Offline
auth-offline-overlay-paragraph-1 = Zaplex can be used offline for local terminal and agent workflows.
...
auth-privacy-settings-help-improve = Help improve Zaplex
auth-privacy-settings-help-improve-description = High-level feature usage data helps Zaplex's product team prioritize the roadmap.
auth-privacy-settings-learn-more = Learn more
auth-privacy-settings-send-crash-reports = Save local crash diagnostics
auth-privacy-settings-crash-reports-description = Stores crash logs and native dumps on this device. Zaplex does not upload them automatically.
...
auth-logout-unsynced-drive-objects-warning = You have { $count } unsynced Zaplex Drive { $count ->
        [one] object
       *[other] objects
...
cli-agent-plugin-codex-install-title = Enable Zaplex Notifications for Codex
cli-agent-plugin-codex-install-subtitle = Update Codex to the latest version, then enable in-focus notifications so Zaplex can display them while you work.
...
cli-agent-plugin-deepseek-install-title = Enable Zaplex Notifications for DeepSeek
...
cli-agent-plugin-claude-install-title = Install Zaplex Plugin for Claude Code
...
cli-agent-plugin-claude-update-title = Update Zaplex Plugin for Claude Code
...
cli-agent-plugin-gemini-install-title = Install Zaplex Plugin for Gemini CLI
...
cli-agent-plugin-gemini-update-title = Update Zaplex Plugin for Gemini CLI
...
cli-agent-plugin-opencode-install-title = Install Zaplex Plugin for OpenCode
...
terminal-bootstrapping-installing-warp-ssh-extension-progress = Installing Zaplex SSH Extension... ({ $p }%)
terminal-bootstrapping-installing-warp-ssh-extension = Installing Zaplex SSH Extension...
terminal-bootstrapping-updating-warp-ssh-extension = Updating Zaplex SSH Extension...
...
agent-tip-command-palette = <keybinding> to open the Command Palette and access Zaplex actions and shortcuts.
...
agent-tip-add-context = `@` to add context from files, blocks, or Zaplex Drive objects to your prompt.
...
agent-tip-oz-headless = Use the `zaplex` command to run an agent in headless mode, useful for remote machines.
...
agent-tip-zaplexify-ssh = Zaplexify a remote SSH session to enable the agent inside that environment.
...
hoa-welcome-banner-title = Introducing universal agent support: level up any coding agent with Zaplex
...
hoa-feature-native-code-review-description = Send inline comments from Zaplex's code review directly to Claude Code, Codex, or OpenCode
resource-center-whats-new-section = What's New?
resource-center-getting-started-section = Getting Started
resource-center-maximize-warp-section = Maximize Zaplex
...
resource-center-command-palette-description = Access all of Zaplex via the keyboard.
resource-center-set-theme-title = Set your theme
resource-center-set-theme-description = Make Zaplex your own by choosing a theme.
resource-center-custom-prompt-title = Use your custom prompt
resource-center-custom-prompt-description = Set up Zaplex to honor your PS1 setting
resource-center-view-documentation = View documentation
resource-center-integrate-ide-title = Integrate Zaplex with your IDE
resource-center-integrate-ide-description = Configure Zaplex to launch from your most used development tools
resource-center-how-warp-uses-warp-title = How Zaplex uses Zaplex
resource-center-how-warp-uses-warp-description = Learn how Zaplex's engineering team uses their favorite features
...
onboarding-intention-title = Welcome to Zaplex
...
onboarding-ai-feature-warp-agents = Zaplex agents
onboarding-ai-feature-oz-cloud-agents-platform = Local agents platform
...
onboarding-agent-title = Customize your Zaplex Agent
...
onboarding-agent-disable-warp-agent = Disable Zaplex Agent
onboarding-project-title = Open a project
onboarding-project-subtitle = Set up a project to optimize it for coding in Zaplex.
...
auth-opt-out-line-1 = Zaplex stores onboarding choices locally.
...
auth-local-privacy-note = Zaplex stores onboarding choices locally on this device.
...
auth-login-slide-title-warp-drive = Get started with Zaplex Drive
...
auth-disable-warp-drive = Disable Zaplex Drive
auth-disable-ai-features = Disable AI features
auth-enable-warp-drive = Enable Zaplex Drive
...
auth-disable-warp-drive-confirm-title = Are you sure you want to disable Zaplex Drive?
auth-disable-ai-features-confirm-title = Are you sure you want to disable AI features?
auth-disable-warp-drive-confirm-body = Zaplex Drive lets you save workflows and knowledge across devices and share them with your team. By continuing, you won't have access to the following features:
auth-disable-ai-features-confirm-body = Zaplex is better with AI. By continuing, you won't have access to any of the following features:
...
auth-require-login-ai-collaboration = Local AI features do not require a Zaplex account.
auth-require-login-drive-limit = Zaplex Drive objects are stored locally in Zaplex.
auth-require-login-share = Sharing is unavailable in local Zaplex builds.
auth-welcome-title = Welcome to Zaplex!
auth-sign-up-for-warp = Continue in Zaplex
...
get-started-welcome-title = Welcome to Zaplex
...
terminal-banner-p10k-supported = Powerlevel10k now supports Zaplex!{"  "}
...
terminal-banner-pure-unsupported = Pure is not yet supported in Zaplex. You might consider one of the supported prompts as an alternative.{"  "}
...
settings-import-reset-to-warp-defaults = Reset to Zaplex defaults
...
workspace-plan-synced-to-warp-drive-toast = Plan synced to your Zaplex Drive
workspace-remote-control-link-copied-toast = Remote control link copied.
workspace-update-now = Update now
workspace-update-warp = Update Zaplex
...
workspace-version-deprecation-without-permissions-banner = Some Zaplex features may not work as expected without updating immediately, but Zaplex is unable to perform the update.
workspace-new-version-unable-to-update-banner = A new version is available but Zaplex is unable to perform the update.
workspace-unable-to-launch-new-installed-version = Zaplex was unable to launch the new installed version.
tab-config-session-type = Session type
tab-config-session-terminal = Terminal
tab-config-session-built-in-agent = Built-in agent
tab-config-select-directory = Select directory
tab-config-worktree-requires-git = Select a Git repository to enable worktree support
tab-config-create-worktree = Automatically create a worktree when opening a new tab
tab-config-branch-name-requires-worktree = Enable automatic worktree creation before generating its branch name
tab-config-autogenerate-branch-name = Auto-generate worktree branch name
...
terminal-zaplexify-without-tmux = Zaplexify without TMUX
terminal-continue-without-zaplexification = Continue without Zaplexification
terminal-always-install = Always install
terminal-never-install = Never install
terminal-ssh-report-issue-prefix = We are actively working on improving the stability of SSH in Zaplex. Please consider{" "}
...
terminal-agent-mode-setup-title = Optimize Zaplex for this codebase?
...
terminal-shell-premature-subtext = Something went wrong while starting { $shell_detail } and Zaplexifying it, causing the process to terminate. Zaplexify script output is displayed here, which may point at a cause.
...
notifications-banner-permissions-denied-title = Zaplex was denied permissions to send you notifications.
...
tooltip-secrets-not-sent-to-warp-server = *Secrets are not sent to Zaplex's server.
...
cockpit-host-action-agent = Open agent
...
cockpit-spawn-card-subtitle = Pick exactly what starts — model and thinking-effort are the launch.
cockpit-spawn-card-agent = Agent
cockpit-spawn-card-mode = Run mode
cockpit-spawn-card-mode-ordinary = Standard
cockpit-spawn-card-mode-managed = Managed
cockpit-spawn-card-mode-remote-control = Claude Remote Control
cockpit-spawn-card-managed-unavailable = Managed unavailable on this host
cockpit-spawn-card-settings = Settings
cockpit-spawn-card-managed-provider-defaults = Uses provider defaults; model, effort and prompt are not applied
cockpit-spawn-card-no-cli = No agent CLI installed — install Claude Code, Codex, or Antigravity
cockpit-spawn-card-model = Model
cockpit-spawn-card-effort = Effort
cockpit-spawn-card-effort-tracked = Effort (tracked)
cockpit-spawn-card-account = Account
cockpit-spawn-card-cli-default = CLI default
cockpit-spawn-card-cli-default-login = CLI default login
cockpit-spawn-card-remote-login = Runs under { $host }'s own CLI login (no local account routing)
cockpit-spawn-card-freest = Freest
cockpit-spawn-card-freest-named = Freest — { $label }
cockpit-spawn-card-host = Host
cockpit-spawn-card-host-local = Local
cockpit-spawn-card-directory = Directory
cockpit-spawn-card-directory-on = Directory (on { $host })
cockpit-spawn-card-dir-host-home = { $host } home
cockpit-spawn-card-browse = Browse…
cockpit-spawn-card-choose-folder = Choose folder…
cockpit-spawn-card-dir-default = Default (home)
cockpit-spawn-card-launching = Launching: { $summary }
cockpit-spawn-card-launch = Launch { $agent }
cockpit-spawn-card-launch-plain = Launch
cockpit-spawn-card-cancel = Cancel
cockpit-spawn-card-sum-host-account = host account
cockpit-spawn-card-sum-freest = freest
cockpit-spawn-card-sum-account-pending-host = account pending host selection
cockpit-spawn-card-sum-account-not-selected = account not selected
cockpit-spawn-card-sum-account-unavailable = account no longer available
cockpit-spawn-card-sum-choose-host = choose host
cockpit-spawn-card-sum-directory-pending-host = directory pending host selection
cockpit-spawn-card-sum-host = host
cockpit-spawn-card-sum-context-million = { $count }M ctx
cockpit-spawn-card-sum-context-thousand = { $count }k ctx
cockpit-spawn-card-sum-local = local
cockpit-spawn-card-sum-remote = remote
cockpit-spawn-card-sum-host-home = { $host } home
cockpit-spawn-card-sum-default = default (home)
workspace-favorites-header = Favorites
workspace-favorites-empty = No favorite hosts yet — ★ a host in the sidebar
...
cockpit-menu-adopt = Open session
cockpit-menu-fork = Fork
cockpit-menu-fork-worktree = Fork into new worktree
cockpit-menu-transcript = History
cockpit-menu-review = Review
cockpit-menu-restart = Restart
cockpit-menu-rename-session = Rename
cockpit-menu-cleanup-stale = Clean up stale entry
cockpit-menu-stop = Stop
cockpit-menu-kill = Kill
cockpit-menu-commit = Commit changes
cockpit-menu-pr = Open pull request
cockpit-session-rename-title = Rename session
cockpit-session-rename-current = Current name: { $name }
cockpit-session-rename-current-empty = This session currently has no name.
cockpit-session-rename-placeholder = Session name
cockpit-session-rename-confirm = Rename
cockpit-session-rename-invalid = Enter a non-empty name of at most 80 bytes without control characters.
cockpit-session-cleanup-title = Clean up stale Claude entry?
cockpit-session-cleanup-body = Removes only the proven-stale registry entry for “{ $session }”. Its history remains available.
cockpit-session-cleanup-confirm = Clean up
...
cockpit-spawn-card-account-count = { $count } accounts
cockpit-spawn-card-all-accounts = All suitable
cockpit-spawn-card-discovering-accounts = Discovering host accounts…
cockpit-spawn-card-select-account = Select an account
cockpit-spawn-card-recent-folders = Recent folders
cockpit-spawn-card-folder-unavailable = unavailable
cockpit-spawn-card-folder-checking = checking
cockpit-spawn-card-folder-verify = verify
cockpit-spawn-card-retry-failed = Retry failed
cockpit-spawn-card-filter-folders = Filter folders…
cockpit-spawn-card-account-inventory-unsupported = This host returned an unsupported AI-account inventory version.
cockpit-spawn-card-account-unavailable = Selected account is no longer available
cockpit-spawn-card-apply-dir-for-models = Apply the selected directory to discover models.
cockpit-spawn-card-choose-host-first = Choose a host first.
cockpit-spawn-card-choose-host-for-directory = Choose a host before selecting a directory.
cockpit-spawn-card-choose-host-for-models = Choose a host to discover models.
cockpit-spawn-card-discovering-models = Discovering models…
cockpit-spawn-card-executable-unavailable = { $agent } executable is no longer available
cockpit-spawn-card-host-fallback = the host
cockpit-spawn-card-model-cli-incompatible = { $agent } on { $host } is incompatible. Update the CLI to discover models.
cockpit-spawn-card-model-discovery-failed = Model discovery failed for { $agent } on { $host }: { $detail }
cockpit-spawn-card-model-host-unavailable = { $host } is offline or unreachable. Reconnect it to discover models.
cockpit-spawn-card-model-host-update = Update and reconnect this host to discover models for the selected account
cockpit-spawn-card-model-native-required = Subscription-agent model discovery requires the native app
cockpit-spawn-card-remote-dir-invalid-utf8 = The selected remote directory is not valid UTF-8
cockpit-spawn-card-requested-host-unavailable = The requested host is unavailable. Choose a host explicitly.
cockpit-spawn-card-use-directory = Use directory
cockpit-spawn-card-web-app = Web app
cockpit-spawn-card-model-cli-version-missing = The remote host did not report its CLI version
cockpit-spawn-card-model-discovery-version-unsupported = The remote host returned an unsupported model-discovery version
cockpit-spawn-card-no-models = the CLI reported no available models
cockpit-spawn-card-no-common-models = the selected accounts do not share an available model
cockpit-spawn-card-batch-route-changed = The selected launch route changed. Review the preview and retry.
cockpit-spawn-card-batch-local-directory-unavailable = The launch directory “{ $path }” is unavailable.
cockpit-spawn-card-batch-connect-host = Connect this host before launching into its directory.
cockpit-spawn-card-batch-remote-directory-unavailable = The remote launch directory “{ $path }” is unavailable.
cockpit-spawn-card-batch-native-required = Remote launches require the native app.
...
cockpit-meter-5h = 5h
cockpit-meter-week = wk
fm-col-name = Name
fm-col-size = Size
fm-col-modified = Modified
fm-search-placeholder = Filter files…
fm-rename-placeholder = New name
fm-folder-name-placeholder = Folder name
fm-key-view = View
fm-key-edit = Edit
fm-key-rename = Rename
fm-key-copy = Copy
fm-key-move = Move
...
fm-verb-move = Move
fm-verb-copy = Copy
fm-dlg-cancel = Cancel
fm-dlg-crossconn-title = { $verb } — { $count } file(s) already exist
fm-dlg-crossconn-body-one = 1 file already exists on the destination. Overwrite it, or skip it?
fm-dlg-crossconn-body-many = { $count } files already exist on the destination. Overwrite them, or skip them?
fm-dlg-overwrite = Overwrite
fm-dlg-skip = Skip
fm-dlg-conflict-title = { $verb } — target exists
fm-dlg-conflict-body-remaining = "{ $name }" already exists in the destination. Overwrite it? ({ $remaining } conflicts remaining)
fm-dlg-conflict-body = "{ $name }" already exists in the destination. Overwrite it?
fm-dlg-overwrite-all = Overwrite all
fm-dlg-skip-all = Skip all
fm-dlg-rename-copy = Keep both
fm-dlg-newer-only = Replace if newer
fm-dlg-rename-copy-all = Keep both for all
fm-dlg-newer-only-all = Replace newer for all
...
fm-dlg-rename-hint = Current name: { $name }
fm-dlg-confirm = Confirm
fm-dlg-newfolder-title = New Folder
fm-dlg-create = Create
fm-dlg-details-title = File Details
fm-dlg-type-file = File
fm-dlg-type-dir = Directory
fm-dlg-type-symlink = Symbolic Link
fm-dlg-type-other = Other
fm-dlg-detail-type = Type
fm-dlg-detail-size = Size
fm-dlg-detail-modified = Modified
fm-dlg-detail-permissions = Permissions
fm-dlg-detail-path = Path
fm-dlg-move-body = Move "{ $name }" to { $target }
fm-dlg-move-title = Move File
fm-dlg-overwrite-upload-body = Remote file { $name } already exists. Overwrite?
fm-dlg-overwrite-download-body = Target file { $name } already exists. Overwrite?
fm-dlg-overwrite-title = Confirm Overwrite
fm-dlg-host-key-title = Verify Server Identity
fm-dlg-host-key-body = The { $key_type } key for { $host }:{ $port } is not trusted yet. Verify this SHA256 fingerprint before continuing: { $fingerprint }
fm-dlg-host-key-confirm = Trust and connect
fm-dlg-host-key-changed-title = Server Identity Changed
fm-dlg-host-key-changed-body = The stored identity for { $host }:{ $port } no longer matches its { $key_type } key. This can indicate an attack or a reinstalled server. Verify the new SHA256 fingerprint through a trusted channel before replacing the stored key: { $fingerprint }
fm-dlg-host-key-changed-confirm = Replace key and connect
fm-dlg-close-transfer-title = Close Transfer Panel
fm-dlg-close-transfer-body = There are active transfer tasks. Closing will cancel all transfers and clear the records. Are you sure?
fm-dlg-close = Close
fm-transfer-waiting = Waiting
fm-transfer-inprogress = Transferring
fm-transfer-verifying = Verifying
fm-transfer-finalizing = Finalizing
fm-transfer-paused = Paused
fm-transfer-cancelling = Cancelling
fm-transfer-pause = Pause
fm-transfer-resume = Resume
fm-transfer-eta = ETA { $seconds }s
fm-transfer-retry-cleanup = Retry cleanup
fm-transfer-recovery-path = Recovery retained at { $path }
fm-transfer-recovery-complete = Retained transfer cleanup completed.
fm-transfer-recovery-started = Retained transfer cleanup started.
fm-transfer-recovery-failed = Retained transfer cleanup failed: { $err }
fm-transfer-completed = Completed
fm-transfer-skipped = Skipped
fm-transfer-partial = Partially completed: { $published } published ({ $transferred } files), { $skipped } skipped
fm-transfer-partial-source-kept = Partially completed: { $published } published ({ $transferred } files), { $skipped } skipped; source kept
fm-transfer-completed-cleanup-required = Destination complete, cleanup required
fm-transfer-completed-source-restored = Destination complete, source restored
fm-transfer-failed = Failed
fm-transfer-cancelled = Cancelled
fm-transfer-title = Transfers ({ $count })
fm-title-sftp = SFTP: { $path }
fm-status-connecting = Connecting…
fm-status-disconnected = Disconnected
fm-status-loading = Loading…
fm-status-connection-cancelled = Connection cancelled
fm-status-server-config-not-found = Server configuration not found
fm-toast-sftp-channel-failed = Failed to create SFTP channel: { $err }
fm-toast-server-config-read-failed = Failed to read server configuration.
fm-toast-not-connected-server = Not connected to server
fm-toast-not-connected = Not connected.
fm-toast-other-pane-disconnected = The other pane is no longer connected.
fm-toast-list-dir-failed = Failed to list directory: { $err }
fm-toast-symlink-target-unresolved = Link target could not be resolved.
fm-toast-unsupported-file-type = This file type cannot be opened safely.
fm-toast-nothing-to-move = Nothing selected to move.
fm-toast-nothing-to-copy = Nothing selected to copy.
fm-toast-open-second-pane-move = Open a second file-manager pane to move into it.
fm-toast-open-second-pane-copy = Open a second file-manager pane to copy into it.
fm-toast-relayed = Relayed { $name }.
fm-toast-relay-failed = Relay of { $name } failed: { $err }
fm-toast-relay-cancelled = Relay of { $name } was cancelled.
fm-toast-relaying-move = Relaying { $count } item(s) to { $target } (move via this machine)…
fm-toast-relaying-copy = Relaying { $count } item(s) to { $target } (copy via this machine)…
fm-toast-same-folder-move = Source and destination are the same folder — nothing to move.
fm-toast-same-folder-copy = Source and destination are the same folder — nothing to copy.
fm-summary-moved = { $count } moved
fm-summary-copied = { $count } copied
fm-summary-queued = { $count } transfers queued
fm-summary-skipped = { $count } skipped
fm-summary-failed = { $count } failed
fm-summary-to-target = { $parts } → { $target }
fm-toast-files-move-started = { $count } file move(s) started
fm-toast-files-copy-started = { $count } file copy(ies) started
fm-toast-folders-move-started = { $count } folder move(s) started
fm-toast-folders-copy-started = { $count } folder copy(ies) started
fm-toast-nothing-to-move-target = Nothing to move → { $target }
fm-toast-nothing-to-copy-target = Nothing to copy → { $target }
fm-toast-skipped-existing = Skipped { $count } existing item(s) → { $target }
fm-toast-partial = Partially completed: { $published } published ({ $transferred } files), { $skipped } skipped
fm-toast-partial-source-kept = Partially completed: { $published } published ({ $transferred } files), { $skipped } skipped; source kept
fm-toast-overwriting-move = Overwriting { $count } existing item(s) (move) → { $target }
fm-toast-overwriting-copy = Overwriting { $count } existing item(s) (copy) → { $target }
fm-toast-dir-nothing-to-transfer = { $label }: nothing to transfer
fm-toast-dir-nothing-to-transfer-existing = { $label }: nothing to transfer ({ $count } already exist)
fm-toast-dir-files-started = { $label }: { $count } file(s) started
fm-toast-dir-files-started-skipped = { $label }: { $count } file(s) started, { $skipped } skipped (exist)
fm-toast-dir-prepare-failed = { $label }: couldn't prepare the transfer: { $err }
fm-toast-dir-prepare-cancelled = { $label }: preparation was cancelled
fm-toast-move-source-kept = { $label }: source kept — some files didn't transfer, so the move is incomplete.
fm-toast-moved = Moved { $label }.
fm-toast-copied = Copied { $label }.
fm-toast-copied-source-remove-failed = Copied { $label } but couldn't remove the source: { $err }
fm-toast-copied-source-delete-failed = Copied, but removing the source failed: { $err }
fm-toast-transfer-failed = Transfer failed: { $err }
fm-toast-delete-failed = Delete failed: { $err }
fm-toast-invalid-filename-chars = Filename contains invalid characters
fm-toast-upload-failed = Upload failed: { $err }
fm-toast-upload-failed-not-connected = Upload failed: not connected to server
fm-toast-download-failed = Download failed: { $err }
fm-toast-download-failed-not-connected = Download failed: not connected to server
fm-toast-name-empty = Name cannot be empty
fm-toast-name-invalid-separators = Invalid name: cannot contain path separators
fm-toast-rename-failed = Rename failed: { $err }
fm-toast-folder-name-empty = Folder name cannot be empty
fm-toast-create-folder-failed = Create folder failed: { $err }
fm-toast-invalid-target-path = Invalid target path
fm-toast-move-failed = Move failed: { $err }
fm-error-connection = The connection was interrupted.
fm-error-operation = The file operation could not be completed.
fm-error-secure-transfer-required = Reconnect this server before making secure file changes.
fm-error-local-io = The local file could not be read or written.
fm-error-credentials = The server credentials are missing or unavailable.
fm-error-unknown-host-key = The server identity needs your confirmation.
fm-error-host-key-mismatch = The server identity changed. The connection was blocked.
fm-error-authentication = The server rejected the credentials.
fm-error-transport = The SSH connection could not be established.
fm-error-cancelled = The transfer was cancelled.
fm-error-committed = The destination was saved, but final confirmation failed.
fm-error-not-found = The requested file or folder no longer exists.
fm-error-recovery-required = The operation needs recovery before it can continue safely.
fm-pickbar-label = Pick a launch directory — { $path }
fm-pickbar-use = Use this folder
fm-drag-hint = Drag files to upload
fm-label-local = local
ssh-server-title = SSH server
ssh-onekey-missing = OneKey credential is missing
ssh-keychain-error = keychain: { $err }
ssh-test-reachable = Server reachable – latency: { $latency }
ssh-test-online = Online – latency: { $latency }
ssh-test-unknown-error = Unknown error
ssh-test-error-timeout = The server did not respond in time
ssh-test-error-name-resolution = The server name could not be resolved
ssh-test-error-refused = The server refused the connection
ssh-test-error-authentication = Authentication failed
ssh-test-error-network = The network route to the server is unavailable
ssh-test-error-host-key = The server identity could not be verified safely
ssh-test-error-client = The local SSH client could not run
ssh-test-error-other = The SSH connection failed
connect-host-key-confirm-title = Confirm SSH server identity?
connect-host-key-confirm-info = { $host }:{ $port } presented the host-key fingerprint { $fingerprint }. Confirm only if this matches the server you intended to connect to.
connect-host-key-cancelled = Persistent connection to { $host } was cancelled because its server identity was not confirmed.
connect-host-key-save-failed = Couldn't save the confirmed server identity for { $host }: { $error }
connect-host-key-changed = The SSH host key for { $host } changed. The connection was blocked.
connect-progress-starting = Connecting to { $host } — starting your persistent session…
connect-progress-setup-complete = Setup complete — starting your persistent session…
connect-progress-setup-failed = Setup failed: { $error } — opened a standard SSH session in a new tab.
connect-fallback-daemon-missing = Persistent session unavailable on { $host }: the zaplex daemon isn't installed there and no install source is available. Opened a standard SSH session instead — a disconnect will lose open work.
