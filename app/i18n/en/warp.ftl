...
zap-launch-oad-description = The Zaplex repo is managed by an agent-first local workflow powered by Oz.
...
agent-tip-zaplexify-ssh = Zaplexify a remote SSH session to enable Oz inside that environment.
