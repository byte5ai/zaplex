...
/// Returns a JS object representing the Zaplex Plugin API exposed to external JavaScript plugins.
///
...
/// Returns a JS object representing the Completions namespace for the Zaplex Plugin API.
///
/// API methods:
///
