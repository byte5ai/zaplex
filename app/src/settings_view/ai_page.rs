...
// AI settings page description text uses i18n; keys are in app/i18n/{en,zh-CN}/warp.ftl settings-ai-* sections.
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                &crate::t!("settings-ai-agent-tips-show"),
                &crate::t!("settings-ai-agent-tips-hide"),
            ),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                &crate::t!("settings-ai-use-agent-footer-show"),
                &crate::t!("settings-ai-use-agent-footer-hide"),
            ),
            builder(SettingsAction::AI(
...
impl AISettingsPageView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        // third-party coding agents rather than Zaplex's own AI.
        Self::update_editor_interaction_state(
        ...
        // Refresh settings page after CLI agent install scan completes (per-agent table appears)
        ctx.subscribe_to_model(
...
pub enum AISettingsPageAction {
    ...
    ToggleShowAgentTips,
    /// Toggle "Show Agent keyboard shortcuts hint" setting (zero-state three-piece + 4 items in message bar footer).
        ...
        let subtext = {
            let subtext_fragments = vec![
                FormattedTextFragment::plain_text(
                    "You haven't added any MCP servers yet. Once you do, you'll be able to control how much autonomy the Zaplex Agent has when interacting with them. ",
                ),
...
struct AIInputWidget {
    ...
    // Switch state handle for "Show Agent keyboard shortcuts hint" toggle.
...
impl SettingsWidget for AIInputWidget {
    ...
    fn render(
        ...
        // "Show Agent keyboard shortcuts hint": controls zero-state three-piece and 4 items in message bar footer.
...
impl SettingsWidget for AIFactWidget {
    ...
    fn render(
        ...
        // Decentralized branch: no longer render "Zaplex Drive as agent context" toggle.
        let _ = self;
        let _ = view;
...
impl VoiceWidget {
    fn render_voice_section(
        ...
        let voice_input_description_text_fragments = vec![
            FormattedTextFragment::plain_text(
                "Voice input allows you to control Zaplex by speaking directly to your terminal (powered by ",
            ),
