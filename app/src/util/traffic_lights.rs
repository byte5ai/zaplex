...
//! depends on the platform. The Zaplex app must use this information to avoid rendering UI elements
//! underneath them.
...
/// Data the Zaplex app needs to avoid rendering anything below the traffic lights.
#[derive(Clone, Debug)]
