...
impl TerminalView {
    ...
    pub fn on_session_share_started(
        ...
        // for sharing UI to reverse-query pane; sharing UI is deleted but shared_session chain is still in,
        // delete this ctx.handle() call when fully retiring shared_session.
