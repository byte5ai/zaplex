//! Logic relating to a secondary process which Zaplex uses to spawn new shell
//! sessions.
//!
...
//! early during Zaplex's initialization, we can be more confident that there are
...
/// between processes, enabling the Zaplex application process to communicate
