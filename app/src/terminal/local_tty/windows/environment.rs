...
const HONOR_PS1_NAME: &str = "ZAPLEX_HONOR_PS1";
const INITIAL_WORKING_DIR_NAME: &str = "ZAPLEX_INITIAL_WORKING_DIR";
const USE_SSH_WRAPPER_NAME: &str = "ZAPLEX_USE_SSH_WRAPPER";
const SHELL_DEBUG_MODE_NAME: &str = "ZAPLEX_SHELL_DEBUG_MODE";
const TERM_PROGRAM_NAME: &str = "TERM_PROGRAM";
const IS_LOCAL_SESSION_NAME: &str = "ZAPLEX_IS_LOCAL_SHELL_SESSION";
const SSH_SOCKET_DIR: &str = "SSH_SOCKET_DIR";
const PATH_APPEND_NAME: &str = "ZAPLEX_PATH_APPEND";
...
pub(super) fn get_shell_environment_variables(options: &PtyOptions) -> Vec<u16> {
    ...
    env.insert(
        map_key("ZAPLEX_CLIENT_VERSION".into()),
        EnvEntry {
            preferred_key: "ZAPLEX_CLIENT_VERSION".into(),
    ...
    if FeatureFlag::HOANotifications.is_enabled() {
        env.insert(
            map_key("ZAPLEX_CLI_AGENT_PROTOCOL_VERSION".into()),
            EnvEntry {
                preferred_key: "ZAPLEX_CLI_AGENT_PROTOCOL_VERSION".into(),
    ...
    // Set ZAPLEX_PATH_APPEND with additional PATH entries to append
