...
pub fn test_block_heights_combined_prompt_command_grid_warp_prompt() {
    ...
    // Note that this test is using the Zaplex prompt, hence the prompt is not included in the combined grid.
    ...
    // we have the built-in Zaplex prompt, so there's padding between that prompt and the combined grid.
...
pub fn test_block_heights_combined_prompt_command_grid_ps1() {
    ...
    // We have a 2-line prompt, adding 1 extra line to the combined grid (vs 0.6 default for Zaplex prompt).
