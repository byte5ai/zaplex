...
pub const EDUCATION_TEXT: &str = "Add secret or command. Zaplex never stores external secrets";
...
impl EnvVarCollectionView {
    ...
    pub fn load(
        ...
        // the ShareableObject injection for env_var_collection is removed; the ServerId path is kept
        // until cloud_object is retired as a whole.
