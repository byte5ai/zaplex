...
/// Representation of locally-loaded conversation data.
///
/// Concrete format depends on the agent harness that generated the conversation.
pub enum LoadedConversationData {
    /// Conversation generated by Oz harness, restorable to [`AIConversation`] data model.
    Oz(Box<AIConversation>),
    /// Conversation generated by external CLI agent harness.
