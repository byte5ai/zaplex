...
- existing instruction files (`AGENTS.md`, `WARP.md`, `CLAUDE.md`, `.warp/rules.md`, `.cursor/rules/`, `.cursorrules`, `.github/copilot-instructions.md`)
- repo-local agent configuration such as `.warp/` files
...
Only ask the user questions if the repo cannot answer something important. Ask one short batch at most.
...
- content better stored in another existing instruction or configuration file and referenced from `AGENTS.md`
