...
impl PassiveSuggestionsModel {
    ...
    fn handle_finished_stream(
        ...
        // Cloud requests for passive suggestions remain disabled because this distribution has no
        // cloud authentication. A future local implementation needs its own structured suggestion
        // transport and must not call the removed cloud endpoint.
