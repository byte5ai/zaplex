...
#[test]
fn restored_conversation_drops_retired_byop_sidecars_on_next_persist() {
    ...
    assert_eq!(conversation_data.compaction_state_json, None);
    assert_eq!(conversation_data.byop_repair_state_json, None);
}
