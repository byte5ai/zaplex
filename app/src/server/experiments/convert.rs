...
impl Display for ServerExperiment {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let str = match self {
            ...
            Self::TmuxSshZaplexificationControl => "TMUX_SSH_ZAPLEXIFICATION_CONTROL",
            Self::TmuxSshZaplexificationExperiment => "TMUX_SSH_ZAPLEXIFICATION_EXPERIMENT",
...
impl ServerExperiment {
    pub fn from_string(s: String) -> Result<Self> {
        match s.as_str() {
            ...
            "TMUX_SSH_ZAPLEXIFICATION_CONTROL" => Ok(Self::TmuxSshZaplexificationControl),
            "TMUX_SSH_ZAPLEXIFICATION_EXPERIMENT" => Ok(Self::TmuxSshZaplexificationExperiment),
