...
/// Singleton model for exporting from Zaplex Drive.
...
impl ExportManager {
    ...
    fn handle_failure(
        ...
        let id = *export.key();
        // Export failure may contain user file paths or object names; only write to local safe logs.
        // Most common cause is local I/O issues.
        safe_warn!(
