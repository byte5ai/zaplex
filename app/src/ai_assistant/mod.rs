//! AI Assistant has since been renamed to "Zaplex AI" in the product.
...
pub const AI_ASSISTANT_FEATURE_NAME: &str = "Zaplex AI";
pub const ASK_AI_ASSISTANT_TEXT: &str = "Ask Zaplex AI";
