...
Zaplex 1.1.1 is the version prepared by this source tree. The table reflects
the integrated source state; supported release artifacts are built, signed and
...
Once published, download Zaplex 1.1.1 from
